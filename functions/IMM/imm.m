function [xhat,Phat,x,P,mu_] = imm(xprev,Pprev,mu_p,yk1,uk,uk1)

global A B C D G H P0 Q R rho0 rho ell ell0 s N u n
...
Lambda = zeros(s,1);
for jj = 1:s
    [x(:,jj),P(:,:,jj),ypred,L] = MJLS_IMM(x0(:,jj),P0j(:,:,jj),jj,jj,yk1,uk,uk1,0);
